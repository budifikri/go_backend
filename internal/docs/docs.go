...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/cash-drawers/open": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Open drawer payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/cash-drawers/{id}/close": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Close drawer payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/invoices/incoming/{id}/cancel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/invoices/incoming/{id}/payments": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/invoices/outgoing/{id}/cancel": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/invoices/outgoing/{id}/payments": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/invoices/summary": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Type (INCOMING|OUTGOING|ALL)",
                        "name": "type",
                        "in": "query"
                    },
                    {
        ...
        "/api/logs/{tahun_bulan}/error": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Year month format (yyyy_mm)",
                        "name": "tahun_bulan",
                        "in": "path",
                        "required": true
                    },
        ...
        "/api/price-tiers": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Price tier payload",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_pos-retail_go_backend_internal_types_request.CreatePurchaseReturnRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_pos-retail_go_backend_internal_types_request.UpdatePurchaseReturnStatusRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/sales": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Sale number search",
                        "name": "sale_number",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        ...
        "github_com_pos-retail_go_backend_internal_types_request.CreatePurchaseReturnRequest": {
            "type": "object",
            "properties": {
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_pos-retail_go_backend_internal_types_request.PurchaseReturnItemRequest"
                    }
                },
                "po_id": {
                    "type": "string"
        ...
        "github_com_pos-retail_go_backend_internal_types_request.PurchaseReturnItemRequest": {
            "type": "object",
            "properties": {
                "amount": {
                    "type": "number"
        ...
        "github_com_pos-retail_go_backend_internal_types_request.UpdatePurchaseReturnStatusRequest": {
            "type": "object",
            "properties": {
                "status": {
                    "type": "string"
