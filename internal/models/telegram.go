...
type TelegramConfig struct {
	...
	TelegramIDClosingDrawer string    `gorm:"column:telegram_id_closing_drawer;type:varchar(50)" json:"telegram_id_closing_drawer"`
	...
	NotifyClosingDrawer     bool      `gorm:"column:notify_closing_drawer;default:false" json:"notify_closing_drawer"`
