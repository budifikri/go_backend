...
type Customer struct {
	...
	Tier           CustomerTier   `gorm:"type:customer_tier;default:'BRONZE'" json:"tier"`
	Status         CustomerStatus `gorm:"type:customer_status;notNull;default:'active'" json:"status"`
...
type Sale struct {
	...
	Status                SaleStatus `gorm:"type:sale_status;notNull;default:'DONE';index" json:"status"`
...
type SalePayment struct {
	ID              uuid.UUID     `gorm:"type:uuid;primaryKey;default:gen_random_uuid()" json:"id"`
	SaleID          uuid.UUID     `gorm:"type:uuid;notNull;index" json:"sale_id"`
	PaymentMethod   PaymentMethod `gorm:"column:payment_method;type:payment_method;notNull" json:"payment_method"`
